      ...
      human => {
        ...
        board => {
          ...
          index => {
            ...
            (index, computerToken) => {
            ...
            }); _defineProperty(this, "computerThink", (board, player) => {
              ...
              human: 'X', computer: 'O', gameStart: false, winner: null, winningSequence: [], board: [0, 1, 2, 3, 4, 5, 6, 7, 8], possibleWins: [[0, 1, 2], // Horizontals
...
const Menu = props => {
  ...
  const buildMenu = () => {
    if (winner === human) {
      ...
      return /*#__PURE__*/(
        React.createElement("section", { id: "Menu", className: showMenu ? 'display' : 'display hidden' }, /*#__PURE__*/
          React.createElement("h1", { className: "title" }, "Begin With..."), /*#__PURE__*/
          React.createElement("hr", null), /*#__PURE__*/
          React.createElement("div", null, /*#__PURE__*/
            React.createElement("button", { onClick: token => startGame('X') }, "X"), /*#__PURE__*/
            React.createElement("button", { onClick: token => startGame('O') }, "O"))));
